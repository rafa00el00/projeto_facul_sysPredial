...
public class GuiMenu extends JFrame implements ActionListener {
	...
	private JMenu mnuArquivo, mnuUsuario, mnuEmpresa, mnuConjunto, mnuArCondicionado, mnuIdiomas, mnuAcessos;
	private JMenuItem mnuItExit, mnuItConsultarConjunto, mnuItConsultarEmpresa, mnuItConsultarUsuario,
			mnuItAlterarArCondicionado, mnuItPT, mnuItEN, mnuItSP, mnuItAcessos;
	...
	public GuiMenu(Usuario user) {
		...
		// Menu Registro de Acesso
		mnuAcessos = new JMenu(Idiomas.getString("GuiMenu.mnuAcessos"));
		mnuAcessos.setMnemonic(Idiomas.getString("GuiMenu.mnuAcessos.mnemonico").charAt(0));
		mnuItAcessos = new JMenuItem(Idiomas.getString("GuiMenu.mnuAcessos.consultar"));
		mnuItAcessos.addActionListener(this);
		mnuAcessos.add(mnuItAcessos);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == mnuItExit) {
			...
			mn.setVisible(true);
			dispose();
		} else if (e.getSource() == mnuItAcessos){
			UsuarioController.consultarAcesso();
		}
